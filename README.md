...
```sh
  mkdir folder_name
  cd folder_name
  git clone git@github.com:tsheporamantso/decode-a-morse-code-message.git
```
...
Feel free to check the [issues page](https://github.com/tsheporamantso/decode-a-morse-code-message/issues).
...
This project is [MIT](https://github.com/tsheporamantso/decode-a-morse-code-message/blob/9df77ad373e98bc789f71f20159e409f61308ea0/LICENSE) licensed.
